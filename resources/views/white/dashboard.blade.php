...
<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar"
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="retirement_dashboard">
    ...
    <li class=" nav-item dash  active">
        <a class="nav-link" href="retirement_dashboard">
...
<!-- End of Sidebar -->
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column" style="background-color: #fff !important">

            <!-- Main Content -->
            <div id="content" class="bg-dark" style="background-color: #fff !important">
                <!-- Topbar -->
...
<div class="mb-2" style="background-color: #fff!important;">
                                ...
                                <ul class="pricing-wrapper">
                                    ...
                                    <li>
                                        ...
                                        <footer class="pricing-footer">
                                            <a href="retirement_dashboard" class="btn btn-success">CURRENT PLAN</a>
                                        </footer>
                                        @else
                                        <header class="pricing-header">
...
<div class="nav-bottom">
            <a href="retirement_dashboard" class="nav__link nav__link--active dash">
