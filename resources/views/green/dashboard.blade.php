...
<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar"
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="premium_dashboard">
    ...
    <li class=" nav-item dash  active">
        <a class="nav-link" href="premium_dashboard">
...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content" class="bg-dark" style="background-color: #088F8F !important">
                <!-- Topbar -->
<nav class="navbar navbar-expand navbar-dark bg-secondary topbar static-top shadow text-white"
    style="background-color: #fff !important">

    <!-- Sidebar Toggle (Topbar) -->
    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3" style="background-color: #fff!important;">
        <i class="fa fa-bars" style="color: #088F8F!important;"></i>
    </button>


    <div class="acct-stat" style="color: #088F8F!important;">
                Account Status - <span
            class="text-capitalize font-weight-bold" style="color: #088F8F!important;">{{Auth::user()->status}}</span>
<br/>
            Login IP Address - <span
            class="text-capitalize font-weight-bold" style="color: #088F8F!important;">{{$reqIP}}</span>
    ...
    <ul class="navbar-nav ml-auto">
       ...
       <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                <i class="fas fa-bell fa-fw" style="color: #088F8F!important;"></i>
                <!-- Counter - Alerts -->
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2" style="color: #088F8F!important;"></i>
...
<div class="mb-2" style="background-color: #088F8F!important;">
    <!-- TradingView Widget BEGIN -->
    <div class="tradingview-widget-container" style="background-color: #088F8F!important;">
...
<!-- End of Topbar -->
                ...
                <!-- Begin Page Content -->
<div class=" container-fluid" style="background-color: #088F8F!important;">
  
<!-- PROFILE PAGE -->
<div id="profile_">
<h3 class="h3 mb-0 text-white text-capitalize">Profile</h3>
...
<h3 class="h3 mb-0 text-white text-capitalize">Deposit</h3>
                                ...
                                <ul class="pricing-wrapper">
                                    ...
                                    <li>
                                        ...
                                        <footer class="pricing-footer">
                                            <a href="premium_dashboard" class="btn btn-success">CURRENT PLAN</a>
                                        </footer>
                                        @else
                                        <header class="pricing-header">
...
<div id="upload_">
<h3 class="h3 mb-0 text-white text-capitalize">Verification / Account</h3>
    <div class="row">
...
<div id="withdraw_">
<h3 class="h3 mb-0 text-white text-capitalize">Withdraw</h3>
...
<h3 class="h3 mb-0 text-white text-capitalize">Change Password</h3>
<form id="changepassw" method="post">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h3 class="h3 mb-0 text-white text-capitalize">Account Type -
    ...
    <div class="row">
            ...
            ">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1" style="color: #088F8F!important;">
                                Invested</div>
                            <div class="h5 mb-0 font-weight-bold" style="color: #088F8F!important;">
                                {{ Auth::user()->currency . ' ' . number_format(Auth::user()->invested, 2) }}</div>
                        </div>
                        <div class="col-auto">
                            @if(Auth::user()->currency == "£")
                            <i class="fa fa-gbp fa-2x" style="color: #088F8F!important;" aria-hidden="true"></i>
                            @elseif(Auth::user()->currency == "$")
                            <i class="fa fa-usd fa-2x" style="color: #088F8F!important;"></i>
                            @else
                            <i class="fa fa-eur fa-2x" style="color: #088F8F!important;" aria-hidden="true"></i>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        ">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1" style="color: #99EDC3!important;">
                                Profit</div>
                            <div class="h5 mb-0 font-weight-bold" style="color: #99EDC3!important;">
                                {{ Auth::user()->currency . ' ' . number_format(Auth::user()->profit, 2) }}</div>
                        </div>
                        <div class="col-auto">
                            <i class="fa fa-bar-chart fa-2x" style="color: #99EDC3!important;"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        ">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fa fa-money fa-2x" style="color: #000!important;"></i>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="nav-bottom">
            <a href="premium_dashboard" class="nav__link nav__link--active dash">
