...
<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar"
    style="background-color: #1f1a40 !important">
...
<nav class="navbar navbar-expand navbar-dark bg-secondary topbar static-top shadow text-white"
    ...
    <div class="acct-stat">
                Account Status - <span
            class="text-capitalize font-weight-bold text-white">{{Auth::user()->status}}</span>
<br/>
            Login IP Address - <span
            class="text-capitalize font-weight-bold text-white">{{$reqIP}}</span>
                                ...
                                <ul class="pricing-wrapper">
                                    ...
                                    <li>
                                        ...
                                        <footer class="pricing-footer">
                                            <a href="dashboard" class="btn btn-success">CURRENT PLAN</a>
                                        </footer>
                                        @else
                                        <header class="pricing-header">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <i class="fa fa-gbp fa-2x text-white" aria-hidden="true"></i>
                            @elseif(Auth::user()->currency == "$")
                            <i class="fa fa-usd fa-2x text-white"></i>
                            @else
                            <i class="fa fa-eur fa-2x text-white" aria-hidden="true"></i>
                            @endif
                        </div>
                    </div>
                </div>
...
<div class="nav-bottom">
            <a href="dashboard" class="nav__link nav__link--active dash">
